...
<p align="center">
<img src="images/image3.png" alt="Figure 3: Correlogram of CD Projekt’s S.A. stock prices" width = 600 />
</p>
...
<p align="center">
<img src="images/image4.png" alt=" Figure 4: Transformed time series using first and seasonal differences" width = 600 />
</p>
...
<p align="center">
<img src="images/image5.png" alt="Figure 5: Transformed time series using log transformation, first and seasonal differences" width = 600 />
</p>
...
<p align="center">
<img src="images/image7.png" alt=" Figure 6: Correlogram of the transformed time series" width = 600 />
</p>
...
<p align="center">
<img src="images/image10.png" alt="Figure 7: Correlogram of the residuals of SARIMA(0,1,2)x(0,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image11.png" alt=" Figure 8: Normality of the residuals of SARIMA (0,1,2)x(0,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image12.png" alt=" Figure 9: Forecast of SARIMA (0,1,2)x(0,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image15.png" alt=" Figure10: Correlogram of the residuals of SARIMA (2,1,2)x(2,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image16.png" alt=" Figure 11: Normality of the residuals of SARIMA (0,1,2)x(0,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image17.png" alt=" Figure 12: Forecast of SARIMA (2,1,2)x(2,1,2)" width = 600 />
</p>
...
<p align="center">
<img src="images/image19.png" alt=" Figure 13: Correlogram of the residuals of SARIMA (0,1,1)x(0,1,1)" width = 600 />
</p>
...
<p align="center">
<img src="images/image20.png" alt=" Figure 14: Normality of the residuals of SARIMA (0,1,1)x(0,1,1)" width = 600 />
</p>
...
<p align="center">
<img src="images/image21.png" alt=" Figure 15: Forecast of SARIMA (0,1,1)x(0,1,1)" width = 600 />
</p>
...
<p align="center">
<img src="images/image22.png" alt=" Figure 16: Forecast of SARIMA (0,1,2)x(0,1,2), SARIMA (2,1,2)x(2,1,2), SARIMA (0,1,1)x(0,1,1)" width = 600 />
</p>
...
Looking at the plots and taking the minimum of presented Root Mean Squared Errors, we can conclude that the best model is SARIMA (0,1,1)x(0,1,1), though the correlogram of the residuals is not truly presenting a realization of a white noise process. The next best model is SARIMA (2,1,2)x(2,1,2). Moreover the residuals of this model are realization of a white noise process.
